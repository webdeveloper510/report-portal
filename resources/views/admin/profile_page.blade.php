                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="input" required name="name" value="{{session('data')['name']}}">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="email" class="col-sm- col-form-label">Email</label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="input" required name="email" value="{{session('data')['email']}}">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="password" class="col-sm- col-form-label">Password</label>
                                                <div class="col-sm-12">
                                                    <input type="password" class="form-control" id="input" required name="password" value="{{session('data')['password']}}">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="address" name="address" required rows="3">{{session('data')['address']}}</textarea>
                                            </div>
