            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Sub Locations</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo URL::to('/'); ?>/index">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Sub Locations</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="mb-3 row">
                                                                ...
                                                                <select class="form-select" name="parent_location" aria-label="Default select example">
                                                                    <option value="">Choose Main Location</option>
                                                                    @foreach($only_main_location as $location)
                                                                    ...
                                                                    <select class="form-select" name="sub_location" onchange="input_show(this)" aria-label="Default select example">
                                                                        <option value="">Select Sub Location</option>
                                                                         @foreach($sublocation_admin as $location1)
                                                                            <option value="{{$location1->sub_location}}">{{$location1->sub_location}}</option>   
                                                                         @endforeach 
                                ...
                                <table class="table user-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$location['sub_address']}}</td>    
                                            <td>
                                            <!-- . '/' . $location['sub_id'] -->
                                               <a data-bs-toggle="modal" data-bs-target="#edit" onclick="showSublocation({{json_encode($location)}})"><i class="fa fa-pencil"  aria-hidden="true" ></i></a>
                                               <a class="h3" data-bs-toggle="modal" data-bs-target="#delete" onclick="return deleteData({{$location['sub_id']}});">
                    ...
                    <form id="edit_sub">
                                <div class="modal fade " id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog p-4">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="Report_user">Edit Sub Location
                                                    </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>                        
                                                <div class="modal-body">   
                                                    <div class="row">                                            
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="mb-3 row">
                                                                <label for="input" class="col-sm-4  col-form-label">Main Location </label>
                                                                <div class="col-sm-">
                                                                <select class="form-select main_location" name="parent_location"  aria-label="Default select example">
                                                                    <option value="">Choose Main Location</option>
                                                                    @foreach($only_main_location as $location)
                                                                         <option  value="{{$location['id']}}">{{$location['parent_location']}}</option>
                                                                     @endforeach
                                                        ...
                                                        <div class="mb-3 row">
                                                                <label for="input" class="col-sm- col-form-label">Address</label>
                                                                <div class="col-sm-12">
                                                                    <textarea type="text" class="form-control address" rows="3" name="address"></textarea>
                                                                </div>
                                                                   <span class="text-danger error-text address_err"></span>
                                                         </div>
                                        ...
                                        <div class="modal-content">
                                           ...
                                           <p>Do you really want to delete these records?<br/>
                                            ...
                                            <div class="text-center">
                                                ...
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#delete" class="btn btn-danger btn-lg" onclick="return DataDelete('sub_location')">Delete</button>
                                            </div>
                                            </div>
