...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="<?php echo URL::to('/'); ?>/public/assets/images/users/1.jpg" alt="user" class="profile-pic me-2">Markarn Doe
                            </a>
    ...
    <script src="<?php echo URL::to('/'); ?>/public/assets/plugins/gmaps/gmaps.min.js"></script>
    <script src="<?php echo URL::to('/'); ?>/public/assets/plugins/gmaps/jquery.gmaps.js"></script>
    <!--Custom JavaScript -->
