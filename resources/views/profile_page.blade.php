                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row ">
                                ...
                                <div class="profile col-md-4 my-5 p-5">  
                                    <div class="mb-3 row">
                                    <img class="profile px-5" src="<?php echo URL::to('/'); ?>/public/assets/images/profiel-image.png"/>
                                    ...
                                    <div class="p-4">           
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-12">
                                            <input type="text" class="form-control" id="input" placeholder="name" value="{{ session('data')['name'] }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-12">
                                            <input type="email" class="form-control" id="input" placeholder=" email" value="{{ session('data')['email'] }}">
                                            </div>
                                        </div>   
                                        <div class="mb-3 row">
                                            <label for="password" class="col-sm- col-form-label">Password</label>
                                            <div class="col-sm-12">
                                            <input type="password" class="form-control" id="input" placeholder="password" value="{{ session('data')['password'] }}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                                <label for="emergencycontact" class="col-sm- col-form-label">Emergency Contact</label>
                                                <div class="col-sm-12">
                                                <input type="number" class="form-control" id="input" placeholder="contact" value="{{ session('data')['phone'] }}">
                                                </div>
                                        </div> 
                                        <div class="mb-3 row">
                                            <label for="input" class="col-sm- col-form-label">Address</label>
                                            <div class="col-sm-12">
                                                <textarea type="text" class="form-control" id="input" rows="3" placeholder="address"></textarea>{{ session('data')['address'] }}                      
                                            </div> 
                                        </div>
                                    <!-- <a href="#" class="btn btn-primary mb-3" type="submit">UPDATE PROFILE</a> -->
                                    </div> 
                                </div>
                                <div class="col-md-4"></div>
                            </form>
